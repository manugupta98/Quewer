...
class CardList extends React.Component {
    ...
    initialize = () => {
        if(this.props.component === CourseEnrollCard) {
            ...
            this.componentList = this.props.list.map((card, index) => <QuestionCard key={index} id={card._id} {...card} postedBy={(card.anonymous) ? "Anonymous" : card.postedBy.name} linked={this.props.linked} answer={this.props.answer} />)
        } else if(this.props.component === QuestionCard) {
            this.componentList = this.props.list.map((card, index) => <QuestionCard key={index} id={card.id} {...card} postedBy={(card.anonymous) ? "Anonymous" : card.postedBy.name} linked={this.props.linked} answer={this.props.answer} />)
