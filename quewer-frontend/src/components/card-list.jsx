...
class CardList extends React.Component {
    ...
    initialize = () => {
        ...
        if(this.props.component === CourseEnrollCard) {
            ...
            this.componentList = this.props.list.map(card => <QuestionCard key={card.id} id={card.id} {...card.attributes} postedBy={card.relationships.postedBy.data.id} linked={this.props.linked} answer={this.props.answer} />)
        } 
    }
