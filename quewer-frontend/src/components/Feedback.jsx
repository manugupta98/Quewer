    ...
    render() {
        return (
            <div className='q-card-main' style={this.props.style}>
                ...
                <QFooter username={this.props.postedBy.name} time={this.props.date}><h3 style={{float: 'left', marginTop: '8px', marginLeft: '10px'}}>Rated: </h3><h3 style={{margin: '5px 10px'}} className='rating-s rating'>{this.props.rating}</h3><br/></QFooter>
            </div>
        );
    }
}
